...
exports.test_map_counter_per_logindomain_per_day_per_country = function (test,assert){
  ...
  var undertest = require('../../../lib/mongo_functions/counter_per_logindomain_per_day_per_country');
  undertest.setVars(ts,emit);
  var scope = {"country":{"country_name":"ireland"},"loginDomain":"testing"};
  undertest.map_counter_per_logindomain_per_day_per_country.call(scope);
  test.finish()
};
