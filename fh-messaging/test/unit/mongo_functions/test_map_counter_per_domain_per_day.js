...
exports.test_map_counter_per_domain_per_day = function (test,assert){
    ...
    var undertest = require('../../../lib/mongo_functions/counter_per_domain_per_day');
    undertest.setVars(ts,emit);
    var scope = {"country":{"country_name":"ireland"},"domain":"testing"};
    undertest.map_counter_per_domain_per_day.call(scope);
    test.finish()
};
