exports.test_metrics_active_device_app_geo = function(test,assert) {
    ...
    var undertest = require('../../../lib/mongo_functions/metrics_active_device_app_geo');
    undertest.setVars(ts,emit);
    var scope = {"_id": {appid:'test_app_id', domain:'test_domain', cuid:'test_cuid'}, "value":{"Ireland": 1}};
    undertest.metrics_active_device_app_geo.call(scope);
    test.finish();
};