...
exports.test_metrics_geo_trans_mongo = function (test,assert){
    ...
    var undertest = require('../../../lib/mongo_functions/metrics_geo_trans');
    undertest.setVars(ts,emit);
    var scope = {"appid":"testapp","domain":"testing","country":{"country_name":"ireland"}};
    undertest.metrics_geo_trans.call(scope);
    test.finish()
};
