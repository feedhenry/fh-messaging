...
exports.test_reduce_aggregated_mongo = function (test,assert){
  var undertest = require('../../../lib/mongo_functions/reduce_aggregated');
  var key = {domain: "testing", ts: new Date().getTime()}
  var val = [{ "Ireland" : 13, "total" : 13 },{ "Ireland" : 13, "total" : 13 }];
  var ret = undertest.metrics_aggregated_reduce(key,val);
