...
exports.initialize = function (test, assert) {
  helper.init( function(err,conf) {
    config = conf;
    logger = require('fh-logger').createLogger({name: 'test_metrics_man_gen_metrics_installs_and_startups'});
...
exports.setUp = function (test, assert) {
  logger.info('setUp');
  config.database.name = "test_fh_metrics_man_gen_metrics_installs_and_startups_msg";
  config.metrics.database.name = "test_fh_metrics_man_gen_metrics_installs_and_startups_met";
  ...
  //appinit_20110612 // Sun Jun 12 2011 23:56:44 GMT+0100 (IST)
  //appinit_20110613 // Mon Jun 13 2011 02:48:41 GMT+0100 (IST)
  //TODO change _ts to be utc value
  testData = {
    "appinit_20110612": {
      "index": 'MD5',
      "data": [
        ...
        {"MD5": "cc522dfd3eabf88b5268b3ed443ad91", "_cl": "dub1b", "_ho": "dub1app2b", "_mn": 96437, "_ts": 1307919404819, "app_version": "32", "appid": "_ychdfEXFfcKf6YJK4hlWQ_a", "destination": "iphone", "domain": "testa", "firsttime": "init", "subscriber": "nJuLGKeMbBGay5qowA6H7O90", "uuid": "df9ac36f2131be5a222fb27599"},
        ...
        {"MD5": "d4156f7d3b4e6e73c9240d6b0459c8b", "_cl": "dub1b", "_ho": "dub1app2b", "_mn": 96196, "_ts": 1307919404819, "app_version": "535", "appid": "PA5kI3YBNgM-HXXrAmn72h5p", "destination": "iphone", "domain": "testa", "firsttime": "init", "subscriber": "nJuLGKeMbBGay5qowA6H7O90", "uuid": "DA63F132D2814B5F8C7DCD157D91DBA5"},
    ...
    "appinit_20110613": {
      ...
      "data": [
        ...
        {"MD5": "asdfsadfas6af874c0a17e0462fdaa7", "_cl": "dub1b", "_ho": "dub1app2b", "_mn": 96656, "_ts": 1307929721110, "app_version": "32", "appid": "_ychdfEXFfcKf6YJK4hlWQ_a", "destination": "android", "domain": "testa", "firsttime": "install", "subscriber": "nJuLGKeMbBGay5qowA6H7O90", "uuid": "71d7050025b002aa20a0564dfcc4f114cab1f338"},
        ...
        {"MD5": "asdfsf0a17e0462fdaa75e4890e883b", "_cl": "dub1b", "_ho": "dub1app2b", "_mn": 96656, "_ts": 1307929721110, "app_version": "32", "appid": "_ychdfEXFfcKf6YJK4hlWQ_a", "destination": "iphone", "domain": "testa", "firsttime": "init", "subscriber": "nJuLGKeMbBGay5qowA6H7O90", "uuid": "71d7050025b002aa20a0564dfcc4f114cab1f338"},
...
exports.test_GenerateMetricsData_installs_and_startups_day1 = function (test, assert) {
  var topic = 'appinit';
  // Test for Sun, 12 Jun 2011
  var messageDate = new Date(1307919404819); //change to use date and utc
    ...
    async.series([
      ...
      function (testCallback) {
        metricsMan.getMetric('appstartupsdest', {
          ...
          assert.equal(2, getMetricData.value.iphone);
          testCallback();
        });
      },
      function (testCallback) {
...
exports.test_GenerateMetricsData_installs_and_startups_day2 = function (test, assert) {
  var topic = 'appinit';
    ...
    async.series([
      ...
      function (testCallback) {
        ...
        metdb.find('appstartupsdest', query3, function (err, results) {
          ...
          assert.equal('testa', data._id.domain);
          assert.equal(expected_metric_ts, data._id.ts);
          assert.equal(3, data.value.android);
          testCallback();
        });
      }
    ], function (err, res) {
