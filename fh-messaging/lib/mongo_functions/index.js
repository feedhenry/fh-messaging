module.exports = {
  ...
  "metricsMapAppRequestDest" : require('./metrics_map_apprequestdest').metrics_map_apprequestdest,
  "metricsReduceAppRequestDest" : require('./metrics_reduce_apprequestdest').metrics_reduce_apprequestdest,
  ...
  "mbaasReduceAppRequestDest": require('./mbaas_reduce_apprequestsdest').mbaas_reduce_apprequestsdest,
